...
class ColorAwareUNet(nn.Module):
    ...
    color_gain:
      ...
      - gain_form='amp' : 1 + tanh(relu(raw)) * gain_scale  (只增不减，更保色)
    ...
    def __init__(
        ...
        gain_min=0.95,         # e.g. 0.8 (only for tanh or general clamp)
    ...
    def forward(self, x):
        ...
        # Gain. Global gain is the paper default; local gain is an ablation.
